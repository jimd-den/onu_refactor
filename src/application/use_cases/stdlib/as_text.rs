...
impl StdlibOpLowerer for AsTextLowerer {
    ...
    fn lower(&self, args: Vec<MirOperand>, builder: &mut MirBuilder) -> MirOperand {
        ...
        builder.build_binop(
            is_gt_zero,
            MirBinOp::Gt,
            MirOperand::Variable(val_ssa, false),
            zero.clone(),
        );
        ...
        builder.build_binop(
            rem_mul,
            MirBinOp::Mul,
            MirOperand::Variable(quot, false),
            ten.clone(),
        );
        ...
        builder.build_binop(
            ...
            MirBinOp::Sub,
            MirOperand::Variable(val_ssa, false),
            MirOperand::Variable(rem_mul, false),
        );
        ...
        builder.build_binop(
            ascii,
            MirBinOp::Add,
            MirOperand::Variable(digit, false),
            ascii_zero.clone(),
        );
        ...
        builder.build_pointer_offset(
            ...
            MirOperand::Variable(idx_ssa, false),
        );
        builder.build_store(
            MirOperand::Variable(target_ptr, false),
            MirOperand::Variable(ascii, false),
        );
        ...
        builder.build_pointer_offset(
            zero_ptr,
            MirOperand::Variable(buf_ssa, false),
            MirOperand::Constant(MirLiteral::I64(30)),
        );
        builder.build_store(MirOperand::Variable(zero_ptr, false), ascii_zero.clone());

        builder.build_assign(idx_ssa, MirOperand::Constant(MirLiteral::I64(29)));
        ...
        builder.build_pointer_offset(
            result_ptr,
            MirOperand::Variable(buf_ssa, false),
            MirOperand::Variable(start_idx, false),
        );
        ...
        builder.build_string_tuple(
            dest,
            MirOperand::Variable(result_len, false),
            MirOperand::Variable(result_ptr, false),
            true,
        );
