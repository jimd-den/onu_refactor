...
#[test] fn collatz_bench_output() { assert_sample_output!("samples/collatz_bench.onu", "Total Peanut Steps for 1 to 1000000 is: 131434424"); }
// Skip echo_demo
...
#[test] fn djb2_hash_output() { assert_sample_output!("samples/djb2_hash.onu", "═══════════════════════════════════════════\n  THE DIGITAL FINGERPRINT (DJB2 Hash)\n  input  =>  DJB2 digest (mod 2^31-1)\n═══════════════════════════════════════════\nhello  =>  261239035\nworld  =>  279393743\nHello  =>  223289563\n═══════════════════════════════════════════"); }
