...
#[test] fn fibonacci_output() { assert_sample_output!("samples/fibonacci.onu", "The population at generation 40 has reached: 102334155"); }
#[test] fn ackermann_output() { assert_sample_output!("samples/ackermann.onu", "═══════════════════════════════════════════  ACKERMANN GROWTH DEMONSTRATION  Rules: Successor, Descent, and Spiral═══════════════════════════════════════════Solving Spiral(2, 2)...7Solving Spiral(3, 2)...29═══════════════════════════════════════════"); }
// Skip bf
#[test] fn collatz_output() { assert_sample_output!("samples/collatz.onu", "COLLATZ SEQUENCE (Starting at 1,000,000):1000000500000250000125000625003125015625468762343811719"); }
#[test] fn collatz_bench_output() { assert_sample_output!("samples/collatz_bench.onu", "Total Collatz steps for 1 to 1000000 is: 131434424"); }
// Skip echo_demo
#[test] fn factorial_output() { assert_sample_output!("samples/factorial.onu", "The accumulation of 5 steps is: 120"); }
// Skip hanoi
...
// Skip map_bench
// Skip mutation
#[test] fn parity_output() { assert_sample_output!("samples/parity.onu", "PARITY VERIFICATION:Is 10 even? (1=yes): 1Is 7 even?  (1=yes): 0"); }
